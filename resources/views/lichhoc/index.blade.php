...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('lichhoc.create') }}" class="btn btn-success mb-3">Thêm Lớp Học Phần</a>
                            ...
                            <tbody>
                                @foreach($monhoc->lophocphans as $lophocphan)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('lichhoc.edit', $lophocphan->lophoc_ID) }}"
                                                class="btn btn-warning btn-sm">Sửa</a>
                                            <form action="{{ route('lichhoc.destroy', $lophocphan->lophoc_ID) }}" method="POST"
